...
const a_stripe = require('./s-routes/api/stripe')
...
const p_user_order_add = require('./s-routes/pages/user/order/add')
...
app.use('/api/stripe', Functionality.stripe(), a_stripe)
...
app.use('/pages/user/order/add', p_user_order_add)
